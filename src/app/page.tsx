  ...
  return (
    <div className="flex h-screen overflow-hidden font-mono">
      ...
      <aside
        ...
        } transition-all duration-300 bg-[#161b22] border-r border-gray-800 flex flex-col overflow-hidden`}
      >
        {/* Header */}
...
function SMTPDetailsView({ copyToClipboard, copiedField }: any) {
  ...
  const smtpData = {
    incomingServer: "arrow.mxrouting.net", // Replace with your actual MXroute server
    imapPort: "993",
    pop3Port: "995",
